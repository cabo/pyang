...
--sid-extension build also a key-mapping entry containing the sid of a list as the object key and the sids of the list's keys as values. This may be use to find elements without refering to the YANG Data Model.
